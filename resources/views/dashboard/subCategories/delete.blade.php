...
@section('dashboard.title', 'Deleted Subcategories')
                    ...
                    <tbody>
                        @foreach($subcategories as $subcategory)
                            <tr>
                                ...
                                <td>
                                    @if(isset($subcategory->category->name) == null) <p class="text-center fw-bold">Deleted</p>
                                    @else{ {{ $subcategory->category->name }} }
                                    @endif
                                </td>
                                ...
                                @if (auth()->user()->user_type == 'admin')
                                        ...
                                        <td class="d-flex justify-content-evenly">
                                                ...
                                                <button type="button" onclick="window.location.href='{{ route('subcategories.restore' , [$subcategory->id]) }}'" class="btn btn-success btn-xs fw-bold">Restore</button> &nbsp; &nbsp;

                                                <form action="{{ route('subcategories.forceDelete', [$subcategory->id]) }}" method="post">  
                                                    @csrf
                                                    {{ method_field('delete') }}
                                                        <button type="submit" class="btn btn-danger btn-xs fw-bold" >Premanatly Delete</button>
                                                </form>
                                        </td>                                    
                                @endif
                            </tr>
