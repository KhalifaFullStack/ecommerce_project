...
<body class="">
          ...
          <div class="row">
            <div
              ...
              <div
                ...
                style="background-image: url('/dashboard/assets/img/illustrations/illustration-signup.jpg'); background-size: cover;">
              </div>
            </div>
  ...
  <script src="/dashboard/assets/js/material-dashboard.min.js?v=3.0.4"></script>
</body>
